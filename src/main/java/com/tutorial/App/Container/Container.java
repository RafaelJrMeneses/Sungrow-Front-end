...
public class Container {
	...
	private Double valorRecebidoDoCallback3;
	
	private Double valorRecebidoDoCallback4;
	public Double getValorRecebidoDoCallback3() {
		return valorRecebidoDoCallback3;
	}

	public void setValorRecebidoDoCallback3(Double valorRecebidoDoCallback3) {
		this.valorRecebidoDoCallback3 = valorRecebidoDoCallback3;
	}

	public Double getValorRecebidoDoCallback4() {
		return valorRecebidoDoCallback4;
	}

	public void setValorRecebidoDoCallback4(Double valorRecebidoDoCallback4) {
		this.valorRecebidoDoCallback4 = valorRecebidoDoCallback4;
	}
	...
	public void Callback() {
		...
		this.conn.setCallback(new MqttCallback() {
			...
			public void messageArrived(String topic, MqttMessage message) throws Exception {
				String s1 = "pi/sng/tempAg";
				String s2 = "pi/sng/tempAm";
				String s3 = "pi/sng/hmd";
				String s4 = "pi/sng/lumin";
				if (topic.equals(s1)) {
					/*
					 * enfileirarChamadas1(new String (message.getPayload()));
					 * System.out.println("Estou enfileirando Ambiente " + new String
					 * (message.getPayload()));
					 */
					Double valor = Double.valueOf(new String(message.getPayload())).doubleValue();
					setValorRecebidoDoCallback1(valor);
				} else {
					if (topic.equals(s2)) {
						/*
						 * enfileirarChamadas2(new String (message.getPayload()));
						 * System.out.println("Estou enfileirando Solucao " + new String
						 * (message.getPayload()));
						 */
						Double valor = Double.valueOf(new String(message.getPayload())).doubleValue();
						setValorRecebidoDoCallback2(valor);
					}else {
						if (topic.equals(s3)) {
							/*
							 * enfileirarChamadas2(new String (message.getPayload()));
							 ...
							 */
							Double valor = Double.valueOf(new String(message.getPayload())).doubleValue();
							setValorRecebidoDoCallback3(valor);
						}else {
							if (topic.equals(s4)) {
								/*
								 * enfileirarChamadas2(new String (message.getPayload()));
								 ...
								 */
								Double valor = Double.valueOf(new String(message.getPayload())).doubleValue();
								setValorRecebidoDoCallback4(valor);
							}
		...
		try {
			...
			conn.subscribe("pi/sng/hmd", 0);
			conn.subscribe("pi/sng/lumin", 0);
		} catch (MqttException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	 ...
	 * 
	 * this.valorEnfileirado1 = this.valorRecebidoDoCallback1; TipoFila tf1 = new
	 * TipoFila(null); tf1.setValor(this.valorEnfileirado1);
	 * this.filaDeValoresDoCallBack1.enfileirar(tf1);
	 * System.out.println("Enfileirou - O tamanho da Fila eh " +
	 * filaDeValoresDoCallBack.mostrarTamanhoDaFila());
	 * //System.out.println("O Ultimo da Fila " +
	 * filaDeValoresDoCallBack.mostrarUltimoDaLista()); System.out.println("Fila1 "
	 * + filaDeValoresDoCallBack1.mostrarFila());
	 * 
	 * }else {
	 * 
	 * criarFila1(); this.valorEnfileirado1 = this.valorRecebidoDoCallback1;
	 * TipoFila tf1 = new TipoFila(null); tf1.setValor(this.valorEnfileirado1);
	 * this.filaDeValoresDoCallBack1.enfileirar(tf1);
	 * System.out.println("Enfileirou C - O tamanho da Fila eh " +
	 * filaDeValoresDoCallBack.mostrarTamanhoDaFila());
	 * //System.out.println("O Ultimo da Fila " +
	 * filaDeValoresDoCallBack.mostrarUltimoDaLista()); System.out.println("Fila1 "
	 * + filaDeValoresDoCallBack1.mostrarFila()); }
	...
	/*
	 * public Fila criarFila1() { Fila f1 = new Fila();
	 * this.filaDeValoresDoCallBack1 =f1; return f1; }
	 */
	 ...
	 * 
	 * this.valorEnfileirado2 = this.valorRecebidoDoCallback2; TipoFila tf2 = new
	 * TipoFila(null); tf2.setValor(this.valorEnfileirado2);
	 * this.filaDeValoresDoCallBack2.enfileirar(tf2);
	 * System.out.println("Enfileirou - O tamanho da Fila eh " +
	 * filaDeValoresDoCallBack.mostrarTamanhoDaFila());
	 * //System.out.println("O Ultimo da Fila " +
	 * filaDeValoresDoCallBack.mostrarUltimoDaLista()); System.out.println("fila2 "
	 * + filaDeValoresDoCallBack2.mostrarFila());
	 * 
	 * }else {
	 * 
	 * criarFila2(); this.valorEnfileirado2 = this.valorRecebidoDoCallback2;
	 * TipoFila tf2 = new TipoFila(null); tf2.setValor(this.valorEnfileirado2);
	 * this.filaDeValoresDoCallBack2.enfileirar(tf2);
	 * System.out.println("Enfileirou C - O tamanho da Fila eh " +
	 * filaDeValoresDoCallBack.mostrarTamanhoDaFila());
	 * //System.out.println("O Ultimo da Fila " +
	 * filaDeValoresDoCallBack.mostrarUltimoDaLista()); System.out.println("Fila 2 "
	 * + filaDeValoresDoCallBack2.mostrarFila()); }
	 * 
	 * 
	 * return filaDeValoresDoCallBack2;
	...
	/*
	 * public Fila criarFila2() { Fila f2 = new Fila();
	 * this.filaDeValoresDoCallBack2 =f2; return f2; }
	 */
